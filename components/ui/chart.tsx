...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    }, [hideLabel, payload, label, labelFormatter, labelKey, labelClassName, config]);
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: ChartTooltipContentProps["payload"] extends infer P ? (P extends Array<infer I> ? I : never) : never, i: number) => {
            ...
            return (
              <div
                key={item.dataKey ? String(item.dataKey) : i}
